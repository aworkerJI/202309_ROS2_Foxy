...
#include "ros_rclpy_package_msgs/srv/detail/multi_spawn__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_rclpy_package_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _MultiSpawn_Request__ros_msg_type = ros_rclpy_package_msgs__srv__MultiSpawn_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_rclpy_package_msgs
size_t get_serialized_size_ros_rclpy_package_msgs__srv__MultiSpawn_Request(
  const void * untyped_ros_message,
...
static uint32_t _MultiSpawn_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_rclpy_package_msgs__srv__MultiSpawn_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_rclpy_package_msgs
size_t max_serialized_size_ros_rclpy_package_msgs__srv__MultiSpawn_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ros_rclpy_package_msgs__srv__MultiSpawn_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_rclpy_package_msgs, srv, MultiSpawn_Request)() {
...
using _MultiSpawn_Response__ros_msg_type = ros_rclpy_package_msgs__srv__MultiSpawn_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_rclpy_package_msgs
size_t get_serialized_size_ros_rclpy_package_msgs__srv__MultiSpawn_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MultiSpawn_Response__ros_msg_type * ros_message = static_cast<const _MultiSpawn_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_rclpy_package_msgs__srv__MultiSpawn_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_rclpy_package_msgs
size_t max_serialized_size_ros_rclpy_package_msgs__srv__MultiSpawn_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ros_rclpy_package_msgs__srv__MultiSpawn_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_rclpy_package_msgs, srv, MultiSpawn_Response)() {
...
// already included above
// #include "ros_rclpy_package_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ros_rclpy_package_msgs/srv/multi_spawn.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_rclpy_package_msgs, srv, MultiSpawn)() {
